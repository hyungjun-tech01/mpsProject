const enResource = {
    translation: {
        ...
        analysis: {
            ...
            privacy_detect_rank_by_user: 'User Rank by Privacy Detect',
            privacy_info_detect_stats:'Detected Private Info. Stats.',
            privacy_last_detect_time: 'The last detected time',
            security_detect_by_dept: 'Security Detect Rate by Dept.',
            security_detect_by_date: 'Security Detect Count by Date',
            security_detect_count: 'No. of cases including security words',
            security_detect_rate: 'Detection Rate',
            security_detect_rank_by_user: 'User Rank by Security Detect',
            select_jobtype: '-- Select Job Type --',
