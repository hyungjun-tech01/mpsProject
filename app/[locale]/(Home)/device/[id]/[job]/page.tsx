...
export default async function Page(props: {
    ...
    const editItems: ISection[] = [
        {
            ...
            items: [
                ...
                { name: 'serial_number', title: t('device.serial_number'), type: 'input', defaultValue: device.serial_number, placeholder: t('device.serial_number') },
                {
                    ...
                    options: [{ label: 'Black', value: device.black_toner_percentage, suffix: 'h-full rounded-full bg-black' },
                    { label: 'Cyan', value: device.cyan_toner_percentage, suffix: 'h-full rounded-full bg-cyan-300' },
                    { label: 'Magenta', value: device.magenta_toner_percentage, suffix: 'h-full rounded-full bg-pink-300' },
                    { label: 'Yellow', value: device.yellow_toner_percentage, suffix: 'h-full rounded-full bg-yellow-300' }
                    ]
                },
            ]
        },
    ...
    const buttonFaxItems: IFaxButtons = {
