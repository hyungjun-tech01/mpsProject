import { Add, NavigateBeforeOutlined, NavigateNextOutlined, Search } from '@mui/icons-material';
...
export function TableSkeleton() {
  return (
    <div className="mt-6 flow-root">
      <div className="inline-block min-w-[700px] align-middle">
            ...
            <thead className="rounded-lg">
              <tr>
                <th scope="col" className="px-4 py-5 font-medium sm:pl-6">
                  <div
                    className={`${shimmer} relative h-8 w-24 overflow-hidden rounded-md bg-gray-200`}
                  />
                </th>
                ...
                <th scope="col" className="px-3 py-5 font-medium">
                  <div
                    className={`${shimmer} relative h-8 w-16 overflow-hidden rounded-md bg-gray-200`}
                  />
                </th>
                <th scope="col" className="px-3 py-5 font-medium">
                  <div
