    ...
    return (
        <div className="flex h-full flex-col px-3 py-4 md:px-2">
            <div className="grid grid-cols-auto-fit gap-2 md:flex md:flex-col md:grow md:justify-between">
                ...
                >
                    <button className="flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md bg-gray-50 text-gray-500 p-3 text-sm font-medium hover:bg-lime-100 hover:text-lime-700 md:flex-none md:justify-start md:p-2 md:px-3">
